...
export default function StatusBadge({ status }: { status: string }) {
  const statusTip = new Map<string, string>(
    Object.entries({
      ...
      "waiting-for-network":
        "Node is trying to connect to the Liberdus network. If your node is stuck in this for more than 15 minutes then please contact us so we can debug and solve this.",
      selected:
